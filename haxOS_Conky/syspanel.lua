...
gauge = {
{
    ...
    caption_fg_colour=0x00FFFF,    caption_fg_alpha=0.9,
},
{
...
},
{
    ...
    graduation_fg_colour=0x00FFFF, graduation_fg_alpha=0.3,
    caption='used',
    caption_weight=0,              caption_size=11,
    caption_fg_colour=0x00FFFF,    caption_fg_alpha=0.9,
},
{
...
{
    name='hwmon',           arg='temp 2',                     max_value=100,
    x=363,                          y=841,
    graph_radius=18,
    graph_thickness=4,
    graph_start_angle=180,
...
{
    name='platform',           arg='coretemp.0 temp 2',                     max_value=100,
    x=265,                          y=687,
    graph_radius=18,
    graph_thickness=4,
    graph_start_angle=180,
...
{
    name='platform',           arg='coretemp.0 temp 3',                     max_value=100,
    x=363,                          y=715,
    graph_radius=18,
    graph_thickness=4,
    graph_start_angle=180,
...
{
    name='platform',           arg='coretemp.0 temp 4',                     max_value=100,
    x=265,                          y=729,
    graph_radius=18,
    graph_thickness=4,
    graph_start_angle=180,
...
{
    name='platform',           arg='coretemp.0 temp 5',                     max_value=100,
    x=363,                          y=757,
    graph_radius=18,
    graph_thickness=4,
    graph_start_angle=180,
...
},
{
    ...
    caption='root',
    caption_weight=1,              caption_size=11,
    caption_fg_colour=0x00FFFF,    caption_fg_alpha=0.9,
},
{
...
function draw_gauge_ring(display, data, value)
    ...
    cairo_select_font_face (display, "monospace", CAIRO_FONT_SLANT_NORMAL, txt_weight)
    ...
    cairo_select_font_face (display, "monospace", CAIRO_FONT_SLANT_NORMAL, caption_weight);
